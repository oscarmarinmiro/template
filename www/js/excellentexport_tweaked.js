...
//            var hrefvalue = uri.excel + base64(format(template.excel, ctx));
            ...
            var xlsData = new Blob([format(template.excel, ctx)], { type: 'data:application/vnd.ms-excel' });
            var xlsUrl = URL.createObjectURL(xlsData);
            anchor.href = xlsUrl;
        ...
        csv: function(anchor, table, delimiter, newLine) {
            ...
            var csvData = new Blob([tableToCSV(table)], { type: 'text/csv' });
